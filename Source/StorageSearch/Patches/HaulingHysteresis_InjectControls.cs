...
namespace StorageSearch {
    ...
    class HaulingHysteresis_InjectControls {
        ...
        private static void DoHysteresisBlock(Rect rect, StorageSettings settings) {
            ...
            storageSettings_Hysteresis.FillPercent = Widgets.HorizontalSlider(rect.LeftPart(0.8f), storageSettings_Hysteresis.FillPercent, 0f, 100f, false, GeneratedDefs.StorageSearchKeys.HaulingHysteresis_RefillCellsLabel.Translate());
