...
namespace StorageSearch {
    ...
    class DialogManageOutfits_DoNameInputRect {
        ...
        public static void Before_DoNameInputRect(ref Rect rect) {
            ...
            // make rename box somewhat smaller (has 35px overlap) + padding, and reduce height by 1 to align boxes
            rect = new Rect(rect.x, rect.y, rect.width - 40f, rect.height -1);
        }
