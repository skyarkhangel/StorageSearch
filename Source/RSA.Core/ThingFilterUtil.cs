namespace RSA.Core
{
    ...
    public static class ThingFilterUtil
    {
        ...
        public static void QueueNextInvocationFilter(
            [NotNull] Func<TreeNode_ThingCategory, TreeNode_ThingCategory> projection)
        {
        ...
        public static void QueueNextInvocationSearch([NotNull] SearchTerm term, string watermark = null)
        {
            FilterSearch_InjectSearchBox.searchOptions.Enqueue(
                new SearchOptions { Term = term, Watermark = watermark });
