namespace RSA.Core.Util
{
    ...
    public static class Access
    {
        ...
        {
            MethodInfo mi = typeof(T).GetProperty(propertyName, BindingFlags.Instance | BindingFlags.NonPublic)
                .GetGetMethod(true);
        ...
        {
            MethodInfo mi = ownerType.GetProperty(propertyName, BindingFlags.Static | BindingFlags.NonPublic)
                .GetGetMethod(true);
